# -*- coding: utf-8 -*-
# Generated by Django 1.11.22 on 2019-08-04 10:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brandname', models.CharField(blank=True, max_length=50, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(0, 'closed'), (1, 'open')], default=1, max_length=20)),
                ('startdate', models.DateTimeField(auto_now_add=True)),
                ('finishdate', models.DateTimeField()),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usermodel.Persons')),
            ],
            options={
                'db_table': 'tasks',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('designation', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='designations', serialize=False, to='usermodel.Employees')),
